...
Trip.create(title: "12 Days in Utah", category: "Adventure", season: "Spring", comments: "Bring a camping tent", user_id: 1)

Trip.create(title: "20 Days in Northern California", category: "Romance", season: "Summer", comments: "Don't forget your camera", user_id: 1)

Trip.create(title: "15 Days in Australia", category: "Family", season: "Fall",comments: "Pack light", user_id: 2)
